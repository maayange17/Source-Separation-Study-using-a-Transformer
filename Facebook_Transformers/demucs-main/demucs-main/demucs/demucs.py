...
import sys
sys.path.append('../../../spacetimeformer-main/')
...
class CutSpacetimeformer(nn.Module):
    def __init__(self,channels):
        ...
        self.Layer = stf.spacetimeformer_model.nn.model.Spacetimeformer(d_x = 1, d_yc = channels, d_yt = 2*channels, embed_method='temporal',
                                                            local_self_attn="none", local_cross_attn="none", 
                                                             pos_emb_type = "t2v",d_model=100).to(device)
