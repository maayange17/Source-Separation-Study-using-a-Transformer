...
class Wavset:
    def __init__(
        ...
        self.savepath = Path('/home/paperspace/Source_Sep_Rea/DataSets/musdb18hqtensors')
        if sum(self.num_examples) < 100:
          self.savepath = self.savepath / 'valid'
        else:
          self.savepath = self.savepath / 'train'
    ...
    def __getitem__(self, index):
        ...
        for name, examples in zip(self.metadata, self.num_examples):
            ...
            #th.save(example, self.savepath / f'{old_index}.pt')
            return example
